              ...
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="w-16 h-16 bg-gray-100 rounded-lg flex-shrink-0 overflow-hidden">
                    {order.products[0]?.product?.images?.length > 0 ? (
                      <img
                        src={order.products[0]?.product?.images[0]} // ✅ show first image
                  ...
                  <div className="flex flex-col min-w-0 ml-4">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-600 mb-2">
                      <p className='text-[#667085] text-[13px] font-normal'>Order No: <span className='text-[#061410] text-[13px] font-normal'>{order.orderNumber}</span></p>
